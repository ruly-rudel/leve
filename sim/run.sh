...
if [ $# -eq 0 ]; then
	files=(`ls -1 ../../riscv-tests/isa/rv64ui-* ../../riscv-tests/isa/rv64um-* ../../riscv-tests/isa/rv64ua-p-* ../../riscv-tests/isa/rv64uf-* ../../riscv-tests/isa/rv64ud-* ../../riscv-tests/isa/rv64uc-* ../../riscv-tests/isa/rv64si-* | grep -v .dump`)
